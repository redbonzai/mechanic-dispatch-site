 ...
 *
 * Type definitions for admin analytics endpoints following constitutional requirements.
 *
 * References:
 * - CLAUDE.md: Module layout (types.ts / functions.ts / PascalCase.ts / index.ts)
 * - docs/standards/common/naming.md: Singular/plural conventions, presence = enablement
 * - docs/standards/common/types.md: Canonical type reuse
 * - docs/admin/ADMIN_API_SPECIFICATION.md: Analytics API requirements
 */
 ...
 *
 * Endpoint: GET /admin/analytics/mechanics
 */
